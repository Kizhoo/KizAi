...
function sb() {
  if (!SUPABASE_URL || !SUPABASE_KEY)
    throw new Error('SUPABASE_URL dan SUPABASE_SERVICE_KEY belum diset di Netlify Environment Variables.');
  return createClient(SUPABASE_URL, SUPABASE_KEY, { auth: { persistSession: false } });
}

/* Harga baru (turun dari sebelumnya) */
const PRICES = {
...
/* Parse Netlify event to req-like object */
...
module.exports = { sb, verifyToken, effectivePlan, accessibleModels, PRICES, MODEL_ACCESS, ok, err, preflight, parseEvent, rateLimit };
